  ...
  <ContentContainer ref="contentContainerRef">
    ...
    <a-form layout="inline" class="mb-4 relative" ref="searchFormRef">
      <a-form-item label="账号">
        <a-input v-model:value="conditions.username" placeholder="请输入" />
      </a-form-item>
      <a-form-item label="昵称">
        <a-input v-model:value="conditions.nickname" placeholder="请输入" />
      </a-form-item>
      <a-form-item label="角色">
        <a-select
          v-model:value="conditions.roleIds"
          placeholder="请选择"
          :style="{
            width: '200px',
          }"
